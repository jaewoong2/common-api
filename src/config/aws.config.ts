...
export default registerAs('aws', () => ({
  ...
  ses: {
    ...
    region: process.env.AWS_SES_REGION || process.env.AWS_DEFAULT_REGION || 'ap-northeast-2',
  },

  /** AWS SQS (Simple Queue Service) */
  sqs: {
    queueUrl: process.env.AWS_SQS_QUEUE_URL || '',
    region: process.env.AWS_SQS_REGION || process.env.AWS_DEFAULT_REGION || 'ap-northeast-2',
  },

  /** AWS Lambda */
  lambda: {
    region: process.env.AWS_LAMBDA_REGION || process.env.AWS_DEFAULT_REGION || 'ap-northeast-2',
  },

  /** AWS EventBridge Scheduler */
  scheduler: {
    region: process.env.AWS_SCHEDULER_REGION || process.env.AWS_DEFAULT_REGION || 'ap-northeast-2',
