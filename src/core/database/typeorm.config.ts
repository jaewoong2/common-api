...
// Webhook entities
import { WebhookRequestEntity } from "../../database/entities/webhook-request.entity";
import { ExchangeKeyEntity } from "../../database/entities/exchange-key.entity";
import { TradeLogEntity } from "../../database/entities/trade-log.entity";
import { ProcessingLockEntity } from "../../database/entities/processing-lock.entity";
...
export const buildTypeOrmOptions = (
  ...
  entities: [
    ...
    OAuthProviderEntity,
    // Webhook entities (webhook schema)
